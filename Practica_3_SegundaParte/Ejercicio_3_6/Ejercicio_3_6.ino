...
byte Usuario1[4] = {0x63, 0x80, 0xB6, 0x2E}; // UID tarjeta CON acceso (reemplaza por tu UID)
byte Usuario2[4] = {0x60, 0xE9, 0xDC, 0x21}; // UID de otra tarjeta que quieras que tenga acceso
